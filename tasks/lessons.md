...
- When a user points to one founder as an example of a broader AI answer problem, audit and update every founder profile and the shared organization data. Do not treat a single indexed result or metadata fix as coverage for the whole team.
